...
const Navbar = () => {
  ...
  return (
    <LinearGradient
      colors={ theme.colors.background == "#fff" ? ["rgba(164, 121, 210, 0.30)", "rgba(164, 121, 210, 0)"] :  ["rgba(210, 206, 121, 0.3)", "rgba(164, 121, 210, 0)"]}
    ...
    >
      <View style={style.container}>
        ...
        <Pressable onPress={() => handleNavigation("/pomodoro")}>
